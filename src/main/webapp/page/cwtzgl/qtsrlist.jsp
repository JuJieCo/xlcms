...
<body>
		...
		<div class="right" id="mainFrame">
			<div class="right_cont">
				<ul class="breadcrumb"> <li>当前位置：首页<span class="divider">/</span>财务台账管理<span class="divider">/</span>其他收入台账管理</li></ul>
				<div class="title_right">
					<strong>查询其他收入台账信息</strong>
				</div>
				
				<div style="width: 95%; margin: auto">
				<form action="${pageContext.request.contextPath}/cwtzglAction!showCwtzglListQTSR" name="form1"  method="post" >
				<s:token name="s_token"></s:token>
					...
					<table class="margin-bottom-20 table  no-border">
						<tr>
							...
							<td class="text-center"><input type="button" value="新建"  onclick="location.href='${pageContext.request.contextPath}/cwtzglAction!showCwtzglQTSRForModify'"  id="modal-9735581" class="btn btn-info btn-small" style="width: 80px;" /></td>
						</tr>
					</table>
					<table class="table table-bordered">
						<tr>
						...
						<tr>
							...
							<td align="center">
								<a href="${pageContext.request.contextPath}/cwtzglAction!showCwtzglQTSR?cwid=${list.cwid}">查看</a>&nbsp;&nbsp;
								<a href="${pageContext.request.contextPath}/cwtzglAction!showCwtzglQTSRForModify?cwid=${list.cwid}">修改</a>&nbsp;&nbsp;
							</td>
						</tr>
						</s:iterator>
					</table>

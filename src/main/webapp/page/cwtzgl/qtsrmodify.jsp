	...
	<div class="right" id="mainFrame">
		<div class="right_cont">
			...
			<div class="title_right">
				<strong>创建其他收入台账信息</strong>
			</div>
			 
			<form name="form" method="post" action="${pageContext.request.contextPath}/cwtzglAction!modifyCwtzglQTSR"   onsubmit="return validateForm(this)">

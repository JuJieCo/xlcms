...
<body>
		...
		<div class="right" id="mainFrame">
			<div class="right_cont">
				<ul class="breadcrumb"> <li>当前位置：首页<span class="divider">/</span>施工单管理<span class="divider">/</span>查询临时施工单</li></ul>
				<div class="title_right">
					<strong>查询临时施工单</strong>
				</div>
				
				<div style="width: 95%; margin: auto">
				<form action="${pageContext.request.contextPath}/shiGongDanAction!showShiGongDanTempList" name="form1"  method="post"   onsubmit="return validateForm(this)">
				<s:token name="s_token"></s:token>
					...
					<table class="table table-bordered">
						...
						<tr>
							...
							<td align="center">
								<a href="${pageContext.request.contextPath}/shiGongDanAction!showShiGongDanTempForModify?gdid=${list.gdid }">修改</a>&nbsp;&nbsp;
								<a href="${pageContext.request.contextPath}/shiGongDanAction!showShiGongDanTempTijiaoForModifyAsUpdate?gdid=${list.gdid }">提交</a>&nbsp;&nbsp;
							</td>
						</tr>
						</s:iterator>
					</table>

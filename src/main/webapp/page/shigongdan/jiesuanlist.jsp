...
<body>
		...
		<div class="right" id="mainFrame">
			<div class="right_cont">
				<ul class="breadcrumb"> <li>当前位置：首页<span class="divider">/</span>施工单管理<span class="divider">/</span>查询结算施工单</li></ul>
				<div class="title_right">
					<strong>查询结算施工单</strong>
				</div>
				
				<div style="width: 95%; margin: auto">
				<form action="${pageContext.request.contextPath}/shiGongDanAction!showShiGongDanJiesuanList" name="form1"  method="post"  onsubmit="return validateForm(this)">
					...
					<table class="table table-bordered">
						...
						<tr>
							...
							<td align="center">
								...
								<c:if test="${list.wxzt ne 4}">
								<a href="${pageContext.request.contextPath}/shiGongDanAction!showShiGongDanJiesuanForModifyAsUpdate?gdid=${list.gdid }">结算</a>&nbsp;&nbsp;
								</c:if>
							</td>
						</tr>
						</s:iterator>

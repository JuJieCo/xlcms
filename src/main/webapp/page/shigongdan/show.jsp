...
<body>
	...
	<div class="right" id="mainFrame">
		<div class="right_cont">
			<ul class="breadcrumb"> <li>当前位置：首页<span class="divider">/</span>施工单管理<span class="divider">/</span>查看施工单</li></ul>
				...
				<div style="width: 95%; margin: auto">
					<table class="table table-bordered">
						<tr>
							...
							<td width="10%" >&nbsp;${shiGongDan.danhao} </td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td  width="10%" >&nbsp;
								<s:iterator value="ryList" var="list">
									<c:if test="${shiGongDan.wxgw == list.ryid}">${list.name}</c:if>
								</s:iterator>
							</td>
						</tr>
						<tr>
							...
							<td>&nbsp;
							 		<c:if test="${shiGongDan.wxzt eq 1}">报价/备料</c:if>
							 		<c:if test="${shiGongDan.wxzt eq 2}">维修施工</c:if>
							 		<c:if test="${shiGongDan.wxzt eq 3}">等待结账</c:if>
							 		<c:if test="${shiGongDan.wxzt eq 4}">结账离店</c:if>
							 		<c:if test="${shiGongDan.wxzt eq 5}">检查未修/无费用</c:if>
							 		<c:if test="${shiGongDan.wxzt eq 6}">挂账离店</c:if>
							</td>
						...
						<tr>
						 ...
						 <tr>
							...
							<td colspan="2" align="center"><font color="red" size="6">¥ ${shiGongDan.zfy}</font></td>
							<td width="10%"  height="50"  align="right" bgcolor="#f1f1f1">实际收款金额：</td>
							<td colspan="2" align="left"><font color="red" size="6">¥ ${shiGongDan.sjzfy}</font></td>
							<td width="10%"  height="50"  align="right" bgcolor="#f1f1f1">保险实际赔付金额：</td>
							<td colspan="2" align="left"><font color="red" size="6">¥ ${shiGongDan.sjpf}</font></td>
						</tr>
					</table>
					...
					<table class="table table-bordered">
						<tr>
							...
							<td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>物料费(进价)</strong></td>
							</c:if>
						...
						<tr>
							...
							<td align="center">&nbsp;${list.llrq }</td>
						 	...
						 	<c:if test="${sessionSysUser.tag eq 1}">
						 	<td align="center">&nbsp;${list.rkjl.danjia }</td>
						 	</c:if>

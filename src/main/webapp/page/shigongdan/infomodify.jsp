...
<body>
	...
	<div class="right" id="mainFrame">
		<div class="right_cont">
			<ul class="breadcrumb"> <li>当前位置：首页<span class="divider">/</span>施工单管理<span class="divider">/</span>施工单信息</li></ul>
			<div class="title_right">
				<strong>修改施工单信息</strong>
			</div>
			 
			<form name="form" method="post" action="${pageContext.request.contextPath}/shiGongDanAction!modifyShiGongDanInfo"   onsubmit="return validateForm(this)">
				...
				<div style="width: 100%; margin: auto">
					<table class="table table-bordered">
							...
							<td>
								<select name="shiGongDan.wxzt"  id="wxzt"  class="span1-1">
									<option value="1" ${shiGongDan.wxzt==1?"selected":"" } >报价/备料</option>
							 		...
							 		<option value="7" ${shiGongDan.wxzt==7?"selected":"" } >临时工单</option>
								</select>
							</td>
						...
						<tr>
							...
							<td >
								<input type="text"  name="shiGongDan.yjwgrq"  id="yjwgrq"  value="${shiGongDan.yjwgrq}"  class="laydate-icon span1-1">
							</td>
						...
						<tr>
							<td width="5%"  height="50"  align="right" bgcolor="#f1f1f1">总费用：</td>
							<td align="left">
								<input type="text" name="shiGongDan.zfy"  id="sjzfy"   value="${shiGongDan.zfy}"   disabled="disabled"  style="font-weight:bold ; color:red ; font-size:35px; height:40px;"  />
							</td>
							
							<td width="5%"  height="50"  align="right" bgcolor="#f1f1f1">实收款：</td>
							<td  align="left">  
		 						<input type="text" name="shiGongDan.sjzfy"  id="sjzfy"   value="${shiGongDan.sjzfy}"   ${shiGongDan.sjzfy=='' or shiGongDan.sjzfy==null ?"disabled":"" } style="font-weight:bold ; color:red ; font-size:35px; height:40px;"  />
							</td>
							
							<td width="5%"  height="50"  align="right" bgcolor="#f1f1f1">保险预计赔付：</td>
							<td align="left"> 
								<input type="text" name="shiGongDan.yjpf"  id="yjpf"   value="${shiGongDan.yjpf}"     ${shiGongDan.yjpf=='' or shiGongDan.yjpf==null ?"disabled":"" }  style="font-weight:bold ; color:red ; font-size:35px; height:40px;"  />
							</td>
							
							<td width="5%"  height="50"  align="right" bgcolor="#f1f1f1">保险实际赔付：</td>
							<td align="left"> 
								<input type="text" name="shiGongDan.sjpf"  id="sjpf"   value="${shiGongDan.sjpf}"    ${shiGongDan.sjpf=='' or shiGongDan.sjpf==null ?"disabled":"" }  style="font-weight:bold ; color:red ; font-size:35px; height:40px;"  />
							</td>
						</tr>
					</table>

...
<body>
		...
		<div class="right" id="mainFrame">
			<div class="right_cont">
				<ul class="breadcrumb"> <li>当前位置：首页<span class="divider">/</span>施工单管理<span class="divider">/</span>查询施工单</li></ul>
				<div class="title_right">
					<strong>查询施工单</strong>
				</div>
				
				<div style="width: 95%; margin: auto">
				<form action="${pageContext.request.contextPath}/shiGongDanAction!showShiGongDanList" name="form1"  method="post"   onsubmit="return validateForm(this)">

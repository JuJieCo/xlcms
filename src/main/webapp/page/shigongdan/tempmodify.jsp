...
<body>
	...
	<div class="right" id="mainFrame">
		<div class="right_cont">
			<ul class="breadcrumb"> <li>当前位置：首页<span class="divider">/</span>施工单管理<span class="divider">/</span>临时施工单</li></ul>
			<div class="title_right">
				<strong>临时施工单</strong>
			</div>
			 
			<form name="form" method="post" action="${pageContext.request.contextPath}/shiGongDanAction!modifyShiGongDanTemp"   onsubmit="return validateForm(this)">
						...
						<tr>
							...
							<td>
								<select name="shiGongDan.wxzt"  id="wxzt"  class="span1-1">
							 		<option value="7" selected="selected">临时工单</option>
								</select>
							</td>

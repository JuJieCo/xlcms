			...
			<div class="right_cont">
				...
				<s:token name="s_token"></s:token>
					...
					<table class="margin-bottom-20 table  no-border">
						<tr>
							<td class="text-left"><input type="button" value="新建"  onclick="location.href='${pageContext.request.contextPath}/userAction!showSysUserForModify'"  id="modal-9735581" class="btn btn-info btn-small" style="width: 80px;" /></td>
						</tr>
					</table>
					<table class="table table-bordered">
						<tr>
							<td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>姓名</strong></td>
							<td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>账号</strong></td>
							<td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>密码</strong></td>
							<td width="20%" align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>操作</strong></td>
						</tr>
						<s:iterator value="userList" var="list">
						<tr>
							<td align="center">&nbsp;${list.rygl.name}</td>
							<td align="center">&nbsp;${list.username }</td>
						  	<td align="center">&nbsp;${list.password }</td>
							<td align="center">
								<a href="${pageContext.request.contextPath}/userAction!showSysUserForModify?userID=${list.userID}">修改</a>&nbsp;&nbsp;
								<a href="${pageContext.request.contextPath}/userAction!showSysRoleList?userID=${list.userID}">授予角色</a>&nbsp;&nbsp;
							</td>
						</tr>
						</s:iterator>
					</table>

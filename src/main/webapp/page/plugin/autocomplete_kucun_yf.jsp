...
$(document).ready(function() {
		...
		oTable.on('click', function(e) {
			...
			$("#wlmc").autocomplete("${pageContext.request.contextPath}/autoCompleteAction!showKuCunYFListAuto", {
				minChars : 1,
				max : 50,
				width : 500,
				matchContains : true,
			...
			$("#wlmc"+num).autocomplete("${pageContext.request.contextPath}/autoCompleteAction!showKuCunYFListAuto", {
				minChars : 1,
				max : 50,
				width : 500,
				matchContains : true,

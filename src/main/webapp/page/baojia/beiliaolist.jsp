...
<body>
		...
		<div class="right" id="mainFrame">
			<div class="right_cont">
				<ul class="breadcrumb"> <li>当前位置：首页<span class="divider">/</span>报价管理 <span class="divider">/</span>查询备料工单</li></ul>
				<div class="title_right">
					<strong>查询备料工单</strong>
				</div>
				
				<div style="width: 95%; margin: auto">
				<form action="${pageContext.request.contextPath}/baoJiaAction!showBeiLiaoSGDList" name="form1"  method="post" >
				<s:token name="s_token"></s:token>
					...
					<table class="table table-bordered">
						...
						<tr>
							...
							<td align="center">
								<a href="${pageContext.request.contextPath}/baoJiaAction!showBeiliaoList?gdid=${list.gdid }">备料</a>&nbsp;&nbsp;
							</td>
						</tr>
						</s:iterator>
					</table>

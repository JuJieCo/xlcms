...
<body>
		...
		<div class="right" id="mainFrame">
			<div class="right_cont">
				<ul class="breadcrumb"> <li>当前位置：首页<span class="divider">/</span>报价管理 <span class="divider">/</span>创建退料单</li></ul>
				...
				<div style="width: 95%; margin: auto">
					...
					<table class="table table-bordered">
						...
						<tr>
							...
							<td align="center">
								<a href="${pageContext.request.contextPath}/baoJiaAction!modifyTuiLiaoForSave?bjid=${list.bjid }&gdid=${shiGongDan.gdid}&kcid=${list.rkjl.kuCun.kcid}&ckid=${list.ckgl.ckid}&shuliang=${list.shuliang}" onclick="return(confirm('确认要退回库存吗?'));">退料</a>&nbsp;&nbsp;
							</td>
						</tr>
						</s:iterator>
					</table>

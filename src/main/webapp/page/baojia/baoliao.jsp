...
<body>
	...
	<%@include file="/page/plugin/autocomplete_baoliao.jsp"%>
	<div class="right" id="mainFrame">
		<div class="right_cont">
			<ul class="breadcrumb"> <li>当前位置：首页<span class="divider">/</span>报价单管理<span class="divider">/</span>创建报料单</li></ul>
			<div class="title_right">
				<strong>创建报料单</strong>
			</div>
			 
			<form name="form" method="post" action="${pageContext.request.contextPath}/baoJiaAction!modifyBaoliaoForSave?gdid=${shiGongDan.gdid}"   onsubmit="return validateForm(this)">
	...
	<table class="table table-bordered"   id="count" >		
		<tr>
			...
			<td width="10%" align="center" bgcolor="#f1f1f1">物料数量:</td>
			<td width="10%">
				<input type="text" name="baoJia.shuliang"  value="${baoJia.shuliang}"  class="span1" >
			</td>

...
<body>
		...
		<div class="right" id="mainFrame">
			<div class="right_cont">
				<ul class="breadcrumb"> <li>当前位置：首页<span class="divider">/</span>库存管理 <span class="divider">/</span>查询专用配件库存</li></ul>
				<div class="title_right">
					<strong>查询专用配件库存</strong>
				</div>
				
				<div style="width: 95%; margin: auto">
				<form action="${pageContext.request.contextPath}/kuCunAction!showKuCunZYList" name="form1"  method="post" >
				<s:token name="s_token"></s:token>
					...
					<table class="margin-bottom-20 table  no-border">
						<tr>
							...
							<td class="text-center"><input type="button" value="新建"  onclick="location.href='${pageContext.request.contextPath}/kuCunAction!showKuCunZYForModifyAsSave'"  id="modal-9735581" class="btn btn-info btn-small" style="width: 80px;" /></td>
						</tr>
					</table>

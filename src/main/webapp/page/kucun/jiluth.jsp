			...
			<div class="right_cont">
				...
				<div style="width: 95%; margin: auto">
					<table class="table table-bordered">
						...
						<table class="table table-bordered">
						<tr>
							<td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>退货日期</strong></td>
							<td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>本次退货数量</strong></td>
							<td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>退货单价</strong></td>
							<td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>总金额</strong></td>
						...
						<s:iterator value="thglList" var="list" status="st">
						<tr>
							<td align="center">&nbsp;${list.thrq }</td>
							<td align="center">&nbsp;${list.bcsl }</td>  
							<td align="center">&nbsp;${list.danjia }</td>
							<td align="center">&nbsp;${list.danjia*list.bcsl }</td>
							<td align="center">&nbsp;${list.ghs }</td>
						 	<td align="center">&nbsp;

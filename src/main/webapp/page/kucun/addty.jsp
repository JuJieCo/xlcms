...
<body>
	...
	<%@include file="/page/plugin/autocomplete_kucun_ty.jsp"%>
	
	<div class="right" id="mainFrame">
		<div class="right_cont">
			<ul class="breadcrumb"> <li>当前位置：首页<span class="divider">/</span>库存管理<span class="divider">/</span>创建通用配件库存</li></ul>
			<div class="title_right">
				<strong>创建通用配件库存</strong>
			</div>
			 
<form name="form" method="post" action="${pageContext.request.contextPath}/kuCunAction!modifyKuCunTYForSave"  onkeydown="if(event.keyCode==13)return false;"  onsubmit="return validateForm(this)">
